	...
	<script type="text/javascript">
		$(function () {
			...
			$("#searchPageBTn").click(function (){
				...
				location.href="http://localhost:8080/Book/clientServlet?action=page&pageNo="+pageNo;
...
<%--				如果用户还没登录 显示登录注册的菜单--%>
	...
	<div id="main">
		<div id="book">
			<div class="book_cond">
				<form action="http://localhost:8080/Book/clientServlet" method="get">
